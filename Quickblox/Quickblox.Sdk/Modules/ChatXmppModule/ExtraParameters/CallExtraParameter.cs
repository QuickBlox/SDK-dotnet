	...
	public class CallExtraParameter : IExtraParameter
	{
		...
		public XElement Build()
		{
			var extraParams = new XElement(XName.Get("extraParams", "jabber:client"),
					...
					new XElement(XName.Get("signalType", "jabber:client"), SignalType.call),
			...
			{
				var element = new XElement(XName.Get("opponentID", "jabber:client"), id);
				opponentsIDs.Add(element);
			}

			extraParams.Add(opponentsIDs);

			extraParams.Add(new XElement(XName.Get("sdp", "jabber:client"), Sdp));
			return extraParams;
		}
	}
}

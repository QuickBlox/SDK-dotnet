...
namespace Xmpp.Client
{
    ...
    internal class XmppClient : IDisposable
    {
        ...
        /// </summary>
        internal event EventHandler<StatusEventArgs> StatusChanged
        {
            add
            {
                im.Status += value;
        ...
        /// </summary>
        internal event EventHandler<MoodChangedEventArgs> MoodChanged
        {
            add
            {
        ...
        /// </summary>
        internal event EventHandler<ActivityChangedEventArgs> ActivityChanged
        {
            add
            {
        ...
        /// </summary>
        internal event EventHandler<TuneEventArgs> Tune
        {
            add
            {
                userTune.Tune += value;
        ...
        /// changed.
        /// </summary>
        internal event EventHandler<ChatStateChangedEventArgs> ChatStateChanged
        {
            add
            {
        ...
        /// </summary>
        internal event EventHandler<Im.ErrorEventArgs> Error
        {
            add
            {
                im.Error += value;
                                        ...
                                        CultureInfo language = null)
        {
            AssertValid();
            to.ThrowIfNull("to");
            return im.SendMessage(to, messageId, body, extraParamets, subject, thread, type, language);
        }
        ...
        internal Message SendMessage(Message xmppMessage)
        {
            ...
            return im.SendMessage(xmppMessage);
        }

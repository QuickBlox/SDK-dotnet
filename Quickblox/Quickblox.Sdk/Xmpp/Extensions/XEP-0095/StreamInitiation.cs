...
namespace Xmpp.Extensions
{
    ...
    internal class StreamInitiation : XmppExtension, IInputFilter<Iq>
    {
        ...
        /// </summary>
        private IDictionary<string, Func<Jid, XElement, XElement>> profiles =
            new Dictionary<string, Func<Jid, XElement, XElement>>();
        ...
        public bool Input(Iq stanza)
        {
            if (stanza.Type != IqType.Set)
                return false;
            var si = stanza.Data.Element("si");
            if (si == null || si.GetDefaultNamespace().NamespaceName != "http://jabber.org/protocol/si")
                return false;
            ...
            else
            {
                try
                {
                    ...
                    var response = profiles[profile].Invoke(stanza.From, stanza.Data.Element("si"));
            ...
            Action<InitiationResult, Iq> cb = null)
        {
            ...
            im.IqRequestAsync(IqType.Set, to, im.Jid, si, null, (id, iq) =>
            {
                ...
                if (iq.Type != IqType.Error)
                {
                    ...
                    result = new InitiationResult(sid, selected, iq.Data.Element("si"));
                }
                cb(result, iq);
            });
            return sid;
        ...
        public void RegisterProfile(string name, Func<Jid, XElement, XElement> cb)
        {
        ...
        /// is null.</exception>
        private XElement CreateFeatureElement(IEnumerable<string> streamOptions)
        {
            streamOptions.ThrowIfNull("streamOptions");
        ...
        private XElement CreateSiElement(string sid, string mimeType, string profile,
            IEnumerable<string> streamOptions, XElement data = null)
        {
            ...
            var si = Xml.Element("si", "http://jabber.org/protocol/si")
                .SetAttribute("id", sid)
                .SetAttribute("mime-type", mimeType)
        ...
        private string ParseStreamMethod(XElement feature)
        {

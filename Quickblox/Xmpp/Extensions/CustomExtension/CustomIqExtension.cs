...
namespace Sharp.Xmpp.Extensions
{
    ...
    internal class CustomIqExtension : XmppExtension, IInputFilter<Iq>
    {
        ...
        public bool Input(Iq stanza)
        {
            ...
            var customIqStanza = stanza.Data.Element("customiq");
            ...
            XDocument targetDocument = XDocument.Parse(query.Value);
            ...
            try
            {
                ...
                response = im.CustomIqDelegate.Invoke(stanza.From, targetDocument.Root.Value);

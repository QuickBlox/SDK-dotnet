    ...
    public class DataField
    {
        ...
        public string Description
        {
            get
            {
                if (element.Element("desc") != null)
                    return element.Element("desc").Value;
                return null;
            }

            private set
            {
                var e = element.Element("desc");
                if (e != null)
                {
                    if (value == null)
            ...
            private set
            {
                if (value == false)
                {
                    if (element.Element("required") != null)
                        element.RemoveChild(element.Element("required"));
                }
                else
                {
                    if (element.Element("required") == null)
        ...
        public IEnumerable<string> Values
        {
            get
            {
                ...
                foreach (XElement e in element.Descendants("value"))
                    set.Add(e.Value);
                return set;
            }
        }
        ...
        internal DataField(XElement element)
        {

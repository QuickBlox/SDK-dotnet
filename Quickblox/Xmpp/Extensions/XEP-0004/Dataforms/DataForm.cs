...
namespace Sharp.Xmpp.Extensions.Dataforms
{
    ...
    public abstract class DataForm
    {
        ...
        public string Instructions
        {
            get
            {
                if (element.Element("instructions") != null)
                    return element.Element("instructions").Value;
                return null;
            }

            set
            {
                var e = element.Element("instructions");
                if (e != null)
                {
                    if (value == null)
                        element.RemoveChild(e);
        ...
        internal DataForm(XElement element, bool readOnly = false)
        {

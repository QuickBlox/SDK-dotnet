    ...
    public class JidField : DataField
    {
        ...
        public Jid Jid
        {
            ...
            private set
            {
                ...
                {
                    if (value == null)
                        element.RemoveChild(element.Element("value"));
                    else
                        element.Element("value").Value = value.ToString();
                }
                else
                {
                    if (value != null)
        ...
        internal JidField(XElement element)
            : base(element)
        {
        ...
        private Jid GetJid()
        {
            XElement v = element.Element("value");
            try
            {
                return v != null ? new Jid(v.Value) : null;
            }
            catch (Exception e)
            {

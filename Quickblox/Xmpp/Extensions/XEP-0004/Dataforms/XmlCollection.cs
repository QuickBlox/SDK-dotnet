...
namespace Xmpp.Extensions.Dataforms
{
    ...
    internal class XmlCollection<T> : ICollection<T> where T : class
    {
        ...
        /// </summary>
        private Func<XElement, T> conversion;
        ...
        public void Add(T item)
        {
            ...
            XElement elem = Xml.Element(tag);
            try
            {
                elem.Value = item.ToString();
            }
        ...
        public XmlCollection(XElement element, string tag, Func<XElement, T> conversion)
        {
        ...
        private ICollection<XElement> GetElements()
        {

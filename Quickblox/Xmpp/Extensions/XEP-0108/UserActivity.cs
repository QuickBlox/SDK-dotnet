...
namespace Sharp.Xmpp.Extensions
{
    ...
    internal class UserActivity : XmppExtension
    {
        ...
        /// event.</param>
        private void onActivity(Jid jid, XElement item)
        {
            if (item == null || item.Element("activity") == null)
                return;
            var activityElement = item.Element("activity");
            XElement temp = null;
            ...
            else
            {
                ...
                foreach (var v in Enum.GetValues(typeof(GeneralActivity)))
                {
                    ...
                    if (activityElement.Element(s) != null)
                    {
                        activity = (GeneralActivity)v;
                        temp = activityElement.Element(s);
                    }
                }
            }
            ...
            if (temp != null)
            {
                ...
                foreach (var v in Enum.GetValues(typeof(SpecificActivity)))
                {
                    ...
                    if (temp.Element(s) != null)
                        specific = (SpecificActivity)v;
                }
            }
            string text = activityElement.Element("text") != null ?
                activityElement.Element("text").Value : null;

...
namespace Quickblox.Sdk.Modules.ChatXmppModule.Interfaces
{
    ...
    public interface IPrivateChatManager
    {
        ...
        /// <returns>Is operation successful</returns>
        bool AddToFriends(bool createChatMessage, string contactName = null);
        ...
        /// <param name="contactName">Opponents name in your contact list</param>
        /// <returns>Is operation successful</returns>
        bool AcceptFriend(bool createChatMessage, string contactName = null);
        ...
        /// <param name="createChatMessage">Notify an opponent with a chat message and add this message to the chat history.</param>
        /// <returns>Is operation successful</returns>
        bool RejectFriend(bool createChatMessage);
        ...
        /// <param name="createChatMessage">Notify an opponent with a chat message and add this message to the chat history.</param>
        /// <returns>Is operation successful</returns>
        bool DeleteFromFriends(bool createChatMessage);

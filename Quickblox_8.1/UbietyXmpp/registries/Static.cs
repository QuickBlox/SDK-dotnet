...
namespace XMPP.registries
{
    public class Static
    {
        ...
        public static readonly XmlReaderSettings Settings = new XmlReaderSettings { ConformanceLevel = ConformanceLevel.Fragment, IgnoreWhitespace = true };
        
        private static XmlNamespaceManager _nsManager = null;
        private static XmlParserContext _context = null;
        ...
        { 
            ...
            {
                if( _context == null )
                    _context = new XmlParserContext(null, NSManager, null, XmlSpace.None);
        ...
        { 
            get 
            {
                if( _nsManager == null )
                {
                    ...
                    _nsManager.AddNamespace("", tags.jabber.client.Namespace.Name);
